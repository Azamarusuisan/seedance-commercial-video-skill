...
Before CM planning, prompt writing, generation, or delivery checks, read:
...
- Do not use web images or third-party materials in final commercial output unless rights are confirmed.
...
- Stop before Higgsfield generation unless the user has approved the CM concept, prompt, reference image, budget, and Higgsfield login/credit state.
