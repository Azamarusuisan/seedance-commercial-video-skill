...
PROMPT_FILE="${GPT_IMAGE_PROMPT_FILE:-workspace/prompts/gpt-image-keiba-reference-v1.txt}"
OUT_FILE="${GPT_IMAGE_OUT:-workspace/assets/reference-keiba-ai-gptimage-v1.png}"
