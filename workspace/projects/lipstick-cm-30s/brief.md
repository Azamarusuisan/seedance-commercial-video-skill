...
Path:
Light path with optional local Blender previs.

Local files prepared:
- Blender previs script: `workspace/blender/lipstick_cm_previs.py`
- Planned Blender render: `workspace/assets/3d/renders/lipstick_cm_previs.png`
- Planned Blender blend: `workspace/assets/3d/blend/lipstick_cm_previs.blend`
- Blender camera storyboard:
...
- Seedance should enrich it with Hollywood-level CG: volumetric light, glossy macro reflections, drifting particles, champagne/red orbit glow, shallow depth of field, and polished camera moves.
- Cast direction: use Rina Hayun only as a fictional AI-generated lips/skin-tone reference for Clip 2. Do not show her full face, do not show her holding the product, and do not present her as a real influencer/customer.
