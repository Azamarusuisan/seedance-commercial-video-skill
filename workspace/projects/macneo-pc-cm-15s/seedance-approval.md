# MacNeo PC CM 15s — Seedance Approval
...
- Japanese subtitles and final title `macneo apple` must be added in post-production.
- Seedance audio is allowed for the first draft. If the audio is not good, strip it and replace with post BGM/SFX.

## Approval Needed

To proceed, confirm:

「MacNeo PC CM 15sのSeedance生成条件を承認します。1本、15秒、16:9、1080p/high、音声あり、参照画像3枚、出力先を確認しました。費用見積後、最終生成許可を取ってください。」
