# MacNeo PC CM 15s — Preproduction Scope Checklist

## Status

Seedance generation is blocked.
...
- [x] Cast policy: no actor
- [x] Audio policy: Seedance music/SFX allowed for draft
- [x] Subtitle policy: Japanese telop in post
- [x] Final title: `macneo apple`
- [ ] Cost estimate: missing
- [ ] Final paid generation approval: missing
- [ ] Publication rights review: missing

## Why This Blocks Generation

Reference images alone produce thin videos because they do not lock:

- what the first two seconds must hook with
- what camera move each beat uses
- how product materials should be enriched
- whether the video has people, dialogue, voice, or only product motion
- where subtitles and final title are composed
- what image is the approved visual target
